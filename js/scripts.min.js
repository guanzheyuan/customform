...
function onloadRadioModal(){
    $("#editorRadioModal_ ").find(".orgname").bind("input propertychange",function(event){
        ...
        $(parentDom).parent().find("label").html($(this).val());
        $(dom).attr('orgname',$(this).val());
...
function checkRadioOption(obj){
    $("#editorRadioModal_").delegate(".checkRadioOption", "change", function (e) {
        ...
        if(e.target.checked){
            ...
            if(''!=valueName && ''!=value){
                var html = '<input type="radio" isRequired="'+isRequired+'" fieldname="'+fieldname+'"  orgname="'+orgname+'"  value='+value+' label='+valueName+'><label  for="">'+valueName+'</label></input>';
