                ...
                if(' '!=allDom[i].attributes.orgname.value){
                    for(var j = 0;j<window.labelArr.length;j++){
                        if(window.labelArr[j].value == allDom[i].attributes.orgname.value){
                            ...
                            formInputElements.labelGridCol = $("#"+allDom[i].attributes.orgname.value).attr("col");
                        }
                    }
                }
                ...
                if(' '!=allDom[i].attributes.orgname.value){
                    for(var j = 0;j<window.labelArr.length;j++){
                        if(window.labelArr[j].value == allDom[i].attributes.orgname.value){
                            ...
                            formSelectElements.labelGridCol = $("#"+allDom[i].attributes.orgname.value).attr("col");
                        }
                    }
                }
                ...
                if(allDom[i].attributes.orgname && ' '!=allDom[i].attributes.orgname.value){
                    for(var j = 0;j<window.labelArr.length;j++){
                        if(window.labelArr[j].value == allDom[i].attributes.orgname.value){
                            ...
                            formTextareaElements.labelGridCol = $("#"+allDom[i].attributes.orgname.value).attr("col");
                        }
                    }
                }
                ...
                if(allDom[i].attributes.orgname && ' '!=allDom[i].attributes.orgname.value){
                    for(var j= 0;j<window.labelArr.length;j++){
                        if(window.labelArr[j].value == allDom[i].attributes.orgname.value){
                            ...
                            formRadioElements.labelGridCol = $("#"+allDom[i].attributes.orgname.value).attr("col");
                        }
                    }
                }
                ...
                if(allDom[i].attributes.orgname && ' '!=allDom[i].attributes.orgname.value){
                    for(var j = 0;j<window.labelArr.length;j++){
                        if(window.labelArr[j].value == allDom[i].attributes.orgname.value){
                            ...
                            formCheckBoxElements.labelGridCol = $("#"+allDom[i].attributes.orgname.value).attr("col");
                        }
                    }
                }
                ...
                if(allDom[i].attributes.orgname && ' '!=allDom[i].attributes.orgname.value){
                    for(var j = 0;j<window.labelArr.length;j++){
                        if(window.labelArr[j].value == allDom[i].attributes.orgname.value){
                            ...
                            formTimeElements.labelGridCol = $("#"+allDom[i].attributes.orgname.value).attr("col");
                        }
                    }
                }
