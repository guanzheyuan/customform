    ...
    $("[data-target=#toJsonModal]").click(function (e) {
		...
		if(inputDom.length > 0){
			for(var i  = 0;i<inputDom.length;i++){
				...
				formInputElements.required = inputDom[i].attributes.isrequired == undefined?'':inputDom[i].attributes.isrequired.value == 'Y';
        ...
        if(selectDom.length > 0){
			for(var i  = 0;i<selectDom.length;i++){
                ...
                formSelectElements.required = selectDom[i].attributes.isrequired == undefined?'':selectDom[i].attributes.isrequired.value == 'Y';
                formSelectElements.value = selectDom[i].attributes.value ==undefined?'':selectDom[i].attributes.value.value;
		...
		if(textareaDom.length > 0){
			for(var i  = 0;i<textareaDom.length;i++){
				...
				formTextareaElements.required = textareaDom[i].attributes.isrequired == undefined?'':textareaDom[i].attributes.isrequired.value == 'Y';
		...
		if(inputRadioDom.length > 0 ){
			for(var i  = 0;i<inputRadioDom.length;i++){
				...
				formRadioElements.required = inputRadioDom[i].attributes.isrequired == undefined?'':inputRadioDom[i].attributes.isrequired.value == 'Y';
		...
		if(inputCheckBoxDom.length > 0){
			for(var i  = 0;i<inputCheckBoxDom.length;i++){
				...
				formCheckBoxElements.required = inputCheckBoxDom[i].attributes.isrequired == undefined?'':inputCheckBoxDom[i].attributes.isrequired.value == 'Y';
		...
		if(inputTimeBoxDom.length > 0){
			for(var i  = 0;i<inputTimeBoxDom.length;i++){
				...
				formTimeElements.required = inputTimeBoxDom[i].attributes.isrequired == undefined?'':inputTimeBoxDom[i].attributes.isrequired.value == 'Y';
        ...
        if($UEditorTextarea.length > 0){
            ...
            console.log(123);
                if('text/plain' == $(this).attr("type")){
                    ...
                    console.log('getContent',UE.getEditor(id).getContent());
