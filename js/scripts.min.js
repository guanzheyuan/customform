...
function loadJson(){
        ...
        for(var i=0;i<allDom.length;i++){
            ...
            if(allDom[i].type == "text"){
                ...
                formInputElements.label = allDom[i].attributes.orgname.value;
            ...
            if(allDom[i].type == "select-one"){
                ...
                formSelectElements.label = allDom[i].attributes.orgname.value;
            ...
            if(allDom[i].type == "textarea"){
                ...
                formTextareaElements.label = allDom[i].attributes.orgname.value;
            ...
            if(allDom[i].type == "radio" ){
                ...
                formRadioElements.label = allDom[i].attributes.orgname.value;
            ...
            if(allDom[i].type == "checkbox"){
                ...
                formCheckBoxElements.label = allDom[i].attributes.orgname.value;
            ...
            if(allDom[i].type == "date"){
                ...
                formTimeElements.label = allDom[i].attributes.orgname.value;
...
function clickFix(obj){
   if($(obj).parent().find(".editLayout").length > 0 || $(obj).parent().find(".editElement").length > 0){
        ...
        if('grid-layout' == dataType && isLayoutClick){
            ...
            var selectDomId = $($(element).parent()[3]).attr("id");
            if(undefined == selectDomId){
                selectDomId = $($(element).parent()[1]).attr("id");
            }
            window.selectDomId = selectDomId;
            ...
            var $children = $("#editorInputModal_ .btn-toors").children();
            var isRequired = $(element).attr('isRequired');
            var $selValue = $($(element.parent()).children()[0]).attr("label");
            $children.each(function(e){
                if($selValue == $(this).data("target")){
                    $(this).css("background-color","#5EA6B7");
                }else{
                    $(this).css("background-color","#FFFFFF");
                }               
            });
            window.inputDom = element;
            window.inputParentDom = element.parent();
            isLayoutClick  = false;
            renderBorder(obj)
            ...
            if(selHtml.length > 0){
                ...
                for(var i = 0;i<selHtml.length ;i++){
                    ids +=$(selHtml[i]).attr('id').split('_')[1]+",";
                    html = '<div id="'+$(selHtml[i]).attr('id').split('_')[1]+'"  style="display:flex;padding-bottom:5px;"><input type="text" name="valueName" value="'+$(selHtml[i]).text()+'" autocomplete="off" class="form-control optionValueName" placeholder="名称" style="width:40%;">&nbsp;&nbsp;<input type="text" value="'+$(selHtml[i]).val()+'" name="value" autocomplete="off" class="form-control optionValue " placeholder="值" style="width:40%;"><div style="padding-top:10px;padding-left:10px;cursor:pointer" onClick="removeSelectOption(this)" ><i class="glyphicon-trash glyphicon"></i></div></div>';
                ...
                if(""!=ids){
                    ...
                    for(var i = 0;i<idArr.length;i++){
                        (function(i){
                            $("#"+idArr[i]).find(".optionValueName").bind("keyup", function () {
                                $("#select_"+idArr[i]).html($(this).val());
                            });
                            $("#"+idArr[i]+" .optionValue").bind("keyup", function () {
                                $("#select_"+idArr[i]).val($(this).val());
                           });
                        })(i)
                    }
                }
            }
            var $children = $("#editorSelectModal_ .btn-toors").children();
            var $selValue = $($(element.parent()).children()[0]).attr("label");
            $children.each(function(e){
                if($selValue == $(this).data("target")){
                    $(this).css("background-color","#5EA6B7");
            ...
            window.selectParentDom = element.parent();
            isLayoutClick  = false;
            renderBorder(obj)
            ...
            var $children = $("#editorTexareaModal_ .btn-toors").children();
            var $selValue = $($(element.parent()).children()[0]).attr("label");
            $children.each(function(e){
                if($selValue == $(this).data("target")){
                    $(this).css("background-color","#5EA6B7");
            ...
            window.textareaParentDom = element.parent();
            isLayoutClick  = false;
            renderBorder(obj)
            ...
            if($inputE.length > 0){
                ...
                for(var i =0;i<$inputE.length;i++){
                    if('radio' == $($inputE[i]).attr('type')){
                        if(undefined != $($inputE[i]).attr('label')){
                            ids +=$($inputE[i]).attr('id').split("_")[1]+",";
                            html='<div id="'+$($inputE[i]).attr('id').split("_")[1]+'" style="display:flex;padding-bottom:5px;options"><input  type="text" name="valueName" autocomplete="off" class="form-control valueName " placeholder="名称" value="'+$($inputE[i]).attr('label')+'" style="width:40%;">&nbsp;&nbsp;<input type="text" name="value" autocomplete="off" class="form-control value" placeholder="值" value="'+$($inputE[i]).val()+'" style="width:40%;"><div style="padding-top:10px;padding-left:10px;cursor:pointer" onClick="removeSelectOption(this)" ><i class="glyphicon-trash glyphicon"></i></div></div>';
                ...
                if(""!=ids){
                    ...
                    for(var j= 0;j<idArr.length;j++){
                        (function(j){
                            $("#"+idArr[j]+" .valueName").bind("keyup", function () {
                                $("#label_"+idArr[j]).html($(this).val());
                                $("#radio_"+idArr[j]).attr("label",$(this).val());
                            });
                            $("#"+idArr[j]+" .value").bind("keyup", function () {
                               $("#radio_"+idArr[j]).val($(this).val());
                            });
                        })(j)
                    }
                }
            }
            var $children = $("#editorRadioModal_ .btn-toors").children();
            var $selValue =$($(element.parent()).prev().prev()).attr("label");
            $children.each(function(e){
                if($selValue == $(this).data("target")){
                    $(this).css("background-color","#5EA6B7");
                }else{
                ...
                if(""!=ids){
                    ...
                    for(var j= 0;j<idArr.length;j++){
                        (function(j){
                            $("#"+idArr[j]+" .valueName").bind("keyup", function () {
                                $("#label_"+idArr[j]).html($(this).val());
                                $("#checkbox_"+idArr[j]).attr("label",$(this).val());
                           });
                           $("#"+idArr[j]+" .value").bind("keyup", function () {
                               $("#checkbox_"+idArr[j]).val($(this).val());
                           });
                        })(j)
                    }
                }
            }
            var $children = $("#editorCheckBoxModal_ .btn-toors").children();
            var $selValue =$($(element.parent()).prev().prev()).attr("label");
            $children.each(function(e){
                if($selValue == $(this).data("target")){
                    $(this).css("background-color","#5EA6B7");
            ...
            var $children = $("#editorDateTimeModal_ .btn-toors").children();
            var $selValue = $($(element.parent()).children()[0]).attr("label");
            $children.each(function(e){
                if($selValue == $(this).data("target")){
                    $(this).css("background-color","#5EA6B7");
            ...
            window.dataTimeParentDom = element.parent();
            isLayoutClick  = false;
            renderBorder(obj)
        }
        else{
...
function onloadDateTimeModal(){
    ...
    $("#editorDateTimeModal_ ").find(".isRequired").bind("input propertychange",function(event){
        ...
        if('Y' == $(this).val()){
            $(dom.parent()).addClass('required')
        }else{
            $(dom.parent()).removeClass('required')
        }
    });
}
/**
...
function onloadCheckBoxModal(){
    ...
    $("#editorCheckBoxModal_ ").find(".isRequired").bind("input propertychange",function(event){
        ...
        if('Y' == $(this).val()){
            $(dom.parent().parent()).addClass('required')
        }else{
            $(dom.parent().parent()).removeClass('required')
        }
    });
}
/**
...
//         var dom = window.checkBoxDom_;
//         var domParent = window.checkParentDom;
//         var checkId = $(e.target).parent().parent().parent().attr("id");
//         if(e.target.checked){
...
//             if(''!=valueName && ''!=value){
//                 var html = '<input id="checkbox_'+checkId+'" type="checkbox" class="getdom" col="'+col+'" isRequired="'+isRequired+'" fieldname="'+fieldname+'"  orgname="'+orgname+'" value='+value+' label='+valueName+'><label id="label_'+checkId+'" for="">'+valueName+'</label></input>';
...
//                     if('checkbox_'+checkId == $(checkHtml[i]).attr('id')){
//                         $(checkHtml[i]).remove();
//                     }
//                 }
//             }
...
//                     if('label_'+checkId == $(labelHtml[i]).attr("id")){
//                         $(labelHtml[i]).remove();
//                     }
//                 }
//             }
...
//             var col = $(dom).attr("col");
//             if(''!=valueName && ''!=value){
//                 var html = '<input id="radio_'+checkId+'" type="radio" class="getdom" col="'+col+'" isRequired="'+isRequired+'" fieldname="'+fieldname+'"  orgname="'+orgname+'"  value='+value+' label='+valueName+'><label id="label_'+checkId+'"  for="">'+valueName+'</label></input>';
//                 if(undefined == $(domParent.children()).attr("label")){
//                     $(domParent).html(html);
//                 }else{
//                     $(domParent).append(html)
...
//                     if('radio_'+checkId == $(radioHtml[i]).attr('id')){
//                         $(radioHtml[i]).remove();
//                     }
//                 }
//             }
...
//            var value =  $valueName.find("[name=value]").val();
//            if(''!=valueName && ''!=value){
//             var html = '<option id="select_'+checkId+'" value='+value+'>'+valueName+'</option>';
//             dom.append(html);
//            }
//         }else{
//             var $valueName =  $(e.target).parent().parent().parent();
...
//             if(selHtml.length > 0){
//                 for(var i = 0;i<selHtml.length ;i++){
//                     if('select_'+checkId == $(selHtml[i]).attr("id")){
//                         $(selHtml[i]).remove();
//                     }
//                 }
//             }
...
function removeRadioOption(obj){
    ...
    if(radioBoxHtml.length > 0){
        for(var i = 0;i<radioBoxHtml.length ;i++){
                ...
                if('radio_'+checkId == $(radioBoxHtml[i]).attr('id')){
...
function removeCheckboxOption(obj){
    ...
    if(checkBoxHtml.length > 0){
        for(var i = 0;i<checkBoxHtml.length ;i++){
                ...
                if('checkbox_'+checkId == $(checkBoxHtml[i]).attr('id')){
...
$(window).resize(function () {
    ...
    $(".height").css("height",$(window).height()-120);
});
$(document).ready(function () {
    ...
    $(".sidebar-nav .box").draggable({
        ...
        stop: function (e,ui) {
            ...
            $demo.find('label,input,select,textarea,radio,checkbox').each(function(e){
                ...
                if(undefined == col){
                    //组件拖拽默认选中
                    var $childs = $(htmlDom).children();
                    for(var i = 0;i<$childs.length;i++){
                        if(undefined == $($childs[i]).attr("level")){
                            clickFix($childs[i]);
                            $($childs[i]).attr("level",'rate');
                        }
                    }
    ...
    $("#sourcepreview").click(function () {
        ...
        $(".demo  .editLayout").children().find('.remove2').addClass('hide');
        return false
    });
    ...
    $("#editorSelectModal_ .addOption").click(function(){
        var id = Math.floor(Math.random()*99999);
        var html = '<div id="'+id+'" style="display:flex;padding-bottom:5px;options"><input type="text" name="valueName " autocomplete="off" class="form-control optionValueName" placeholder="名称" value="下拉选项" style="width:40%;">&nbsp;&nbsp;<input type="text" name="value" autocomplete="off" class="form-control optionValue" placeholder="值" value="下拉值" style="width:40%;"><div style="padding-top:10px;padding-left:10px;cursor:pointer" onClick="removeSelectOption(this)" ><i class="glyphicon-trash glyphicon"></i></div></div>';
        $("#editorSelectModal_  .addSelectOption").append(html);
        //初始化添加
        var dom = window.selectDom_;
        var valueName = $("#"+id).find(".optionValueName").val();
        var value = $("#"+id).find(".optionValue").val();
        var html = '<option id="select_'+id+'" value='+value+'>'+valueName+'</option>';
        dom.append(html);
        $("#"+id+" .optionValueName").bind("keyup", function () {
             $("#select_"+id).html($(this).val());
        });
        $("#"+id+" .optionValue").bind("keyup", function () {
    ...
    $("#editorRadioModal_ .addOption").click(function(){
        var id = Math.floor(Math.random()*99999);
        var html = '<div id="'+id+'"  style="display:flex;padding-bottom:5px;options"><input type="text" name="valueName" autocomplete="off" class="form-control  valueName" placeholder="名称" value="单选" style="width:40%;">&nbsp;&nbsp;<input type="text" name="value" autocomplete="off" class="form-control value" placeholder="值" value="单选值" style="width:40%;"><div style="padding-top:10px;padding-left:10px;cursor:pointer" onClick="removeRadioOption(this)" ><i class="glyphicon-trash glyphicon"></i></div></div>';
        $("#editorRadioModal_  .addRadioOption").append(html);
        //初始化添加
        var dom = window.radioDom_;
        var domParent = window.radioParentDom;
        var valueName =$("#"+id).find(".valueName").val();
        var value =  $("#"+id).find(".value").val();
        var orgname = $(dom).attr("orgname");
        var fieldname = $(dom).attr("fieldname");
        var isRequired = $(dom).attr("isRequired");
        var col = $(dom).attr("col");
        var html = '<input id="radio_'+id+'" type="radio" class="getdom" col="'+col+'" isRequired="'+isRequired+'" fieldname="'+fieldname+'"  orgname="'+orgname+'"  value='+value+' label='+valueName+'><label id="label_'+id+'"  for="">'+valueName+'</label></input>';
        $(domParent).append(html);
        $("#"+id+" .valueName").bind("keyup", function () {
            $("#label_"+id).html($(this).val());
            $("#radio_"+id).attr("label",$(this).val());
       });
       $("#"+id+" .value").bind("keyup", function () {
           $("#radio_"+id).val($(this).val());
       });
    });
    /**
     * 多选 添加选项
    ...
    $("#editorCheckBoxModal_ .addOption").click(function(){
        var id = Math.floor(Math.random()*99999);
        var html = '<div id="'+id+'" style="display:flex;padding-bottom:5px;options"><input type="text" name="valueName" autocomplete="off" class="form-control valueName" placeholder="名称" value="复选名称" style="width:40%;">&nbsp;&nbsp;<input type="text" name="value" autocomplete="off" class="form-control value" value="复选值" placeholder="值" style="width:40%;"><div style="padding-top:10px;padding-left:10px;cursor:pointer" onClick="removeCheckboxOption(this)" ><i class="glyphicon-trash glyphicon"></i></div></div>';
        $("#editorCheckBoxModal_  .addCheckboxOption").append(html);
        //初始化添加
        var dom = window.checkBoxDom_;
        var domParent = window.checkParentDom;
        ...
        var isRequired = $(dom).attr("isRequired");
        var col = $(dom).attr("col");
        var html = '<input id="checkbox_'+id+'" type="checkbox" class="getdom" col="'+col+'" isRequired="'+isRequired+'" fieldname="'+fieldname+'"  orgname="'+orgname+'" value='+value+' label='+valueName+'><label id="label_'+id+'" for="">'+valueName+'</label></input>';
        $(domParent).append(html);
        $("#"+id+" .valueName").bind("keyup", function () {
            $("#label_"+id).html($(this).val());
            $("#checkbox_"+id).attr("label",$(this).val());
       });
       $("#"+id+" .value").bind("keyup", function () {
           $("#checkbox_"+id).val($(this).val());
       });
    });
    /**
     * 输入框按钮组 切换
     */
    $("#editorInputModal_ .btn-toor").click(function(e){
        var $target = $(this).data("target");
        var $children = $("#editorInputModal_ .btn-toors").children();
        var $label = $($(window.inputParentDom).children()[0]);
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $label.css("text-align",$target);
     ...
     * 下拉框标签按钮组 切换
     */
    $("#editorSelectModal_ .btn-toor").click(function(e){
        var $target = $(this).data("target");
        var $children = $("#editorSelectModal_ .btn-toors").children();
        var $label = $($(window.selectParentDom).children()[0])
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $label.css("text-align",$target);
            $label.attr("label",$target);
     ...
     * 多行文本框中增加 按钮组切换
     */
    $("#editorTexareaModal_ .btn-toor").click(function(e){
        var $target = $(this).data("target");
        var $children = $("#editorTexareaModal_ .btn-toors").children();
        var $label = $($(window.textareaParentDom).children()[0]);
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $label.css("text-align",$target);
            $label.attr("label",$target);
     ...
     * 单选左右按钮组配置
     */
    $("#editorRadioModal_ .btn-toor").click(function(e){
        var $target = $(this).data("target");
        var $children = $("#editorRadioModal_ .btn-toors").children();
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $($(window.radioParentDom).prev().prev()).css("text-align",$target);
            $($(window.radioParentDom).prev().prev()).attr("label",$target);
            $children.each(function(e){
                if($target != $(this).data("target")){
                    $(this).css("background-color","#FFFFFF");
                }
     ...
     * 多选框按钮组切换
     */
    $("#editorCheckBoxModal_ .btn-toor").click(function(e){
        var $target = $(this).data("target");
        var $children = $("#editorCheckBoxModal_ .btn-toors").children();
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $($(window.checkParentDom).prev().prev()).css("text-align",$target);
            $($(window.checkParentDom).prev().prev()).attr("label",$target);
            $children.each(function(e){
                if($target != $(this).data("target")){
                    $(this).css("background-color","#FFFFFF");
                }
     ...
     * 时间 左右中布局按钮组
     */
    $("#editorDateTimeModal_ .btn-toor").click(function(e){
        var $target = $(this).data("target");
        var $children = $("#editorDateTimeModal_ .btn-toors").children();
        var isRequired = $(window.dateTimeDom_).attr("isRequired");
        var $label = $($(window.dataTimeParentDom).children()[0]);
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $label.css("text-align",$target);
            $label.attr("label",$target);
