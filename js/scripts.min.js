...
$(document).ready(function () {
    ...
    $("#editorSelectModal_ .addOption").click(function(){
        var id = Math.floor(Math.random()*99999);
        var html = '<div id="'+id+'" style="display:flex;padding-bottom:5px;options">&nbsp;&nbsp;<input type="text" name="valueName " autocomplete="off" class="form-control optionValueName" placeholder="名称" value="下拉选项" style="width:35%;">&nbsp;&nbsp;<input type="text" name="value" autocomplete="off" class="form-control optionValue" placeholder="值" value="下拉值" style="width:35%;"><div style="padding-top:10px;padding-left:10px;cursor:pointer" onClick="removeSelectOption(this)" ><i class="glyphicon-trash glyphicon"></i></div></div>';
        $("#editorSelectModal_  .addSelectOption").append(html);
        //初始化添加
        var dom = window.selectDom_;
