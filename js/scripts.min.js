...
function onloadDateTimeModal(){
    ...
    $("#editorDateTimeModal_ ").find(".isRequired").bind("input propertychange",function(event){
        ...
        if('Y' == $(this).val()){
            ...
            $(dom.prev()).before('<font id="'+id+'" style="color:red;padding-top:10px;">*</font>&nbsp;');
        }else{
...
function onloadCheckBoxModal(){
    ...
    $("#editorCheckBoxModal_ ").find(".isRequired").bind("input propertychange",function(event){
        ...
        if('Y' == $(this).val()){
            var id = Math.floor(Math.random()*1000);
            $(dom).attr('isRequiredId',id);
            $(dom.parent().prev().prev()).before('<font id="'+id+'" style="color:red;padding-top:10px;">*</font>&nbsp;');
        }else{
            $("#"+$(dom).attr("isRequiredId")).remove();
        }
    });
...
function onloadRadioModal(){
    ...
    $("#editorRadioModal_ ").find(".isRequired").bind("input propertychange",function(event){
        ...
        if('Y' == $(this).val()){
            ...
            var id = Math.floor(Math.random()*1000);
            $(dom).attr('isRequiredId',id);
            $(parentDom).parent().find('.radio_label').before('<font id="'+id+'" style="color:red;padding-top:10px;">*</font>&nbsp;');
        }else{
            $("#"+$(dom).attr("isRequiredId")).remove();
        }
    });
...
$(document).ready(function () {
    ...
    $("#editorSelectModal_ .addOption").click(function(){
        var id = Math.floor(Math.random()*99999);
        var html = '<div id="'+id+'" style="display:flex;padding-bottom:5px;options">&nbsp;&nbsp;<div class="checkbox checkSelectOption" ><label> <input type="checkbox"style="zoom:140%;"></label></div><input type="text" name="valueName " autocomplete="off" class="form-control optionValueName" placeholder="名称" style="width:30%;">&nbsp;&nbsp;<input type="text" name="value" autocomplete="off" class="form-control optionValue" placeholder="值" style="width:30%;"><div style="padding-top:10px;padding-left:10px;cursor:pointer" onClick="removeSelectOption(this)" ><i class="glyphicon-trash glyphicon"></i></div></div>';
    ...
    $("#editorInputModal_ .btn-toor").click(function(e){
        ...
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $($(window.inputParentDom).children()[0]).css("text-align",$target);
            $($(window.inputParentDom).children()[0]).attr("label",$target);
            $children.each(function(e){
    ...
    $("#editorSelectModal_ .btn-toor").click(function(e){
        ...
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $($(window.selectParentDom).children()[0]).css("text-align",$target);
            $($(window.selectParentDom).children()[0]).attr("label",$target);
            $children.each(function(e){
                if($target != $(this).data("target")){
                    $(this).css("background-color","#FFFFFF");
                }
    ...
    $("#editorTexareaModal_ .btn-toor").click(function(e){
        ...
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $($(window.textareaParentDom).children()[0]).css("text-align",$target);
            $($(window.textareaParentDom).children()[0]).attr("label",$target);
            $children.each(function(e){
                if($target != $(this).data("target")){
                    $(this).css("background-color","#FFFFFF");
                }
    ...
    $("#editorDateTimeModal_ .btn-toor").click(function(e){
        ...
        if('right' == $target){
            $(this).css("background-color","#5EA6B7");
            $($(window.dataTimeParentDom).children()[0]).css("text-align",$target);
            $($(window.dataTimeParentDom).children()[0]).attr("label",$target);
            $children.each(function(e){
                if($target != $(this).data("target")){
                    $(this).css("background-color","#FFFFFF");
                }
