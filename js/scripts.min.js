...
$(document).ready(function () {
    ...
    $("#edit").click(function () {
        ...
        $(".devpreview .demo .column").css("padding-top","20px");
        $(".devpreview .demo .column").css("padding-bottom","20px");
        return false
    });
    ...
    $("#sourcepreview").click(function () {
        ...
        removeMenuClasses();
        $(this).addClass("active");
        $(".devpreview .demo .column").css("padding-top","2px");
        $(".devpreview .demo .column").css("padding-bottom","2px");
        return false
    });
    ...
    $(".savecontent").click(function(){
        ...
        if('data-input' == nameFlag){
            ...
            var serializeArray = $('#editorSelectModal #selectForm').serializeArray();
				for(var i = 0;i<serializeArray.length;i++){
					if('fieldname' == serializeArray[i].name){
						$(dom).attr('id',serializeArray[i].value);
				...
				var optionHtml = ' ';
				$("#selectForm table tbody").find("tr").each(function(){
            ...
            var serializeArray = $('#editorTextareaModal #textareaForm').serializeArray();
			for(var i = 0;i<serializeArray.length;i++){
				if('fieldname' == serializeArray[i].name){
					$(dom).attr('id',serializeArray[i].value);
					$(dom).attr('name',serializeArray[i].value)
